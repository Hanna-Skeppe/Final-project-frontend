      ...
      <TopTextWrapper>
        <TitleWrapper>
          ...
          {accessToken && (
            <>
              {isFavorite && (
                <FavoriteButton type="submit" onClick={handleRemoveFavorite}>
                  <FavoriteOutlinedIcon
                    style={{ fontSize: 42, fill: '#495867' }}
                  />
                </FavoriteButton>
              )}
              {!isFavorite && (
                <FavoriteButton type="submit" onClick={handleAddFavorite}>
        ...
        <InfoTextWrapper>
          <Table>
            <tbody>
              ...
              <Tr>
                <Th>Sulfites</Th>
                <Td>{added_sulfites}</Td>
              </Tr>
              <Tr>
                <Th>Avg. price</Th>
                <Td>{average_price} (SEK)</Td>
              </Tr>
              <Tr>
                <Th>Goes well with</Th>
                <Td>{goes_well_with}</Td>
              </Tr>
              <Tr>
                <Th>Importer</Th>
                <Td>{importer}</Td>
